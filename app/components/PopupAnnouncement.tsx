...
export default function PopupAnnouncement() {
  ...
  useEffect(() => {
    ...
    setMounted(true);
    // 2. Tunda sedikit biar animasinya jalan mulus saat web terbuka
    const timer = setTimeout(() => setIsOpen(true), 500);
    return () => clearTimeout(timer);
  }, []);

  // Kalau belum ke-load di browser, jangan render apa-apa
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-lg bg-[#0a0b10] border border-red-500/30 rounded-xl overflow-hidden shadow-[0_0_50px_rgba(220,38,38,0.3)] flex flex-col"
            style={{
