              ...
              <AnimatePresence mode="wait">
                ...
                {voteSuccess && (
                  ...
                  >
                    ...
                    <div className="relative w-[90px] md:w-[180px] aspect-[9/16] rounded-lg overflow-hidden shadow-[0_0_30px_rgba(220,38,38,0.3)] mb-4 border border-white/20 shrink-0">
                      <Image
