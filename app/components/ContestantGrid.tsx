              ...
              <AnimatePresence mode="wait">
                ...
                {!showRules && !voteSuccess && (
                  ...
                  >
                    ...
                    <div className="flex justify-center mb-6">
                      <ReCAPTCHA
                        sitekey="6LfaDucsAAAAAKDhQfxODC3hHWeLq4XWeAJRnArr"
                ...
                {voteSuccess && (
                  ...
                  >
                    ...
                    <p className="text-gray-400 text-[18px] md:text-sm mb-4 shrink-0">
                      Terima kasih{" "}
                      <strong className="text-white">
                        @{igUsername.replace("@", "")}
                      </strong>
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                animate={{ scale: 1, y: 0 }}
                exit={{ scale: 0.9, y: 20 }}
                className={`w-full bg-black rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(220,38,38,0.4)] border border-red-500/20 relative z-[100000] ${activeVideo.includes("instagram") ? "h-[75vh] md:h-[85vh]" : "aspect-video"}`}
